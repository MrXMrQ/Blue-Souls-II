...
public class GameLauncher {
    ...
    public static Character[] characters() {
        ...
        Character warrior = new Character("Warrior", 100, 100, 100, 4, 4, 250, 0, 0, "Warrior",1000,100);
        Character wizard = new Character("Wizard", 100, 100, 100, 4, 4, 250, 0, 0, "Wizard",1000,100);
        Character confessor = new Character("Confessor", 100, 100, 100, 4, 4, 250, 0, 0, "Confessor",1000,100);
