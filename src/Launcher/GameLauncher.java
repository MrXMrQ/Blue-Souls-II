...
public class GameLauncher {
    ...
    public static Character[] characters() {
        ...
        Character knight = new Character("Knight", 1000, 100, 20, 4, 4, 250, 0, 0, "Knight",1000,100);
        Character warrior = new Character("Warrior", 1000, 100, 100, 4, 4, 250, 0, 0, "Warrior",1000,100);
        Character wizard = new Character("Wizard", 1000, 100, 100, 4, 4, 250, 0, 0, "Wizard",1000,100);
        Character confessor = new Character("Confessor", 1000, 100, 100, 4, 4, 250, 0, 0, "Confessor",1000,100);
